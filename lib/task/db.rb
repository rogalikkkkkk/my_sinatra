...
namespace :db do
  ...
  ENV['DATABASE'] = 'sinatra_seq' if environment == 'development'
  ENV['DATABASE'] = 'sinatra_seq' if environment == 'test'
  ENV['DATABASE'] = 'sinatra_seq' if environment == 'production'
